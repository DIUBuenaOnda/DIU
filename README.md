...
La evaluación de la práctica la encontrará en el siguiente [pdf](P4\P4_UsabReport_CASICAU_doneby_DIU3_BuenaOnda.pdf).


## Conclusión final / Valoración de las prácticas


Ha sido muy interesante e instructivo el haber aprendido durante la práctica la metodología e implementación del uso de patrones de diseño UI/UX. Hemos aprendido, no solo a mejorar una página, si no a seguir los pasos necesarios para crear un mejor diseño web en futuros proyectos.
